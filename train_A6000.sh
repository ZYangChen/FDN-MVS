#!/usr/bin/env bash
MVS_TRAINING="/home/chenziyang/MVS/MVSData/dtu/"
BLEND_TRAINING="/home/chenziyang/MVS/MVSData/BlendedMVS/"
...
##DTU
python -u train.py --mode='train' --epochs=16 --numdepth=384 --trainviews=5 --testviews=5 --logdir $LOG_DIR --dataset=dtu_yao_1to8_inverse --batch_size=1 --trainpath=$MVS_TRAINING \
