...
def disp_warp(img, disp, padding_mode='border'):
    ...
    warped_img = F.grid_sample(img, sample_grid, align_corners=True, mode='bilinear', padding_mode=padding_mode)

    mask = torch.ones_like(img)
    valid_mask = F.grid_sample(mask, sample_grid, align_corners=True, mode='bilinear', padding_mode='zeros')
